    ...
    <div className="max-w-[1200px] mx-auto space-y-6">
      ...
      <div>
        ...
        <div className="flex items-center gap-2 text-[11px] font-medium text-gray-500 mt-2">
          ...
          <ChevronRight className="w-3 h-3" />
          <span className="text-[#081326]">CIVIL Score</span>
        </div>
      </div>

      {/* Client Selector */}
      <div className="flex items-center gap-2 text-sm font-bold text-[#081326] cursor-pointer w-fit hover:text-[#f59e0b] transition-colors">
