  ...
  return (
    <div className="bg-white p-4 xl:p-6 rounded-[20px] shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-50 flex flex-col h-full overflow-hidden">
      <div className="flex justify-between items-center mb-4 shrink-0">
        <h3 className="font-bold text-[#081326] text-sm xl:text-base">Client Distribution</h3>
        <select className="text-[10px] xl:text-[11px] font-semibold text-gray-500 bg-gray-50 border border-gray-100 rounded-lg px-2 py-1 outline-none">
          <option>India</option>
        </select>
      </div>
      
      <div className="flex-1 flex flex-row items-center gap-2 xl:gap-4 min-h-0">
        
        {/* Map Section */}
        <div className="flex-1 max-w-[55%] relative flex items-center justify-center">
          <div className="w-full aspect-square relative">
            <svg 
              ...
              className="fill-blue-100 stroke-blue-200 stroke-[5]"
            >
