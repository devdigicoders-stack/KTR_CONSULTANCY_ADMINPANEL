...
const data = [
  { name: 'Active', value: 4, color: '#16a34a' }, /* Green */
  { name: 'Closed', value: 2, color: '#94a3b8' }, /* Gray */
  { name: 'Default', value: 0, color: '#ef4444' } /* Red */
];
...
const CreditInfoTab = () => {
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 space-y-8">
      ...
      {/* Client Selector (simulated to match screenshot) */}
